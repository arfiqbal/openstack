    ...
    public function store(Request $request)
    {
       ...
       // $script_source = public_path('startup.sh');
        ...
        if($request){
            ...
            ob_flush();
            flush();
            array_push($ipPool['nr_provider'], '10.85.50.170', '10.85.50.123', '10.85.51.198','10.85.50.203', '10.85.51.199', '10.85.51.142', '10.85.50.245', '10.85.50.230', '10.85.51.189', '10.85.51.9', '10.85.51.15', '10.85.51.16');
