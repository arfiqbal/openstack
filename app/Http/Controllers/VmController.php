    ...
    public function store(Request $request)
    {
       ...
       // $script_source = public_path('startup.sh');
        ...
        if($request){
            ...
            $totalVssiIP = $this->openstack->listIpAddressSlice('10.38.64.0','22',0,-24);
            ...
            ob_flush();
            flush();
            array_push($ipPool['nr_provider'], '10.85.50.170', '10.85.50.123', '10.85.51.198','10.85.50.203', '10.85.51.199', '10.85.51.142', '10.85.50.245', '10.85.50.230', '10.85.51.189', '10.85.51.9', '10.85.51.15', '10.85.51.16', '10.85.50.250','10.85.51.0', '10.85.51.1');
            array_push($ipPool['r_provider'], '10.38.107.123','10.38.107.203','10.38.107.170', '10.38.107.250','10.38.107.255');
            array_push($ipPool['vssi_routable'], '10.38.64.9','10.38.64.198','10.38.64.199','10.38.64.189','10.38.64.15','10.38.64.16','10.38.64.0','10.38.64.1');
