...
class ApplicationsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        ["uid" => "84060f9a-b40e-49d4-aa72-28c78d1d0639", "initial_count" => 0 , "image" => "img_cpns_ce_ubuntu_16.04", "version" => "16.04", "os" => "ubuntu" ,"name" => "ce"],
        ["uid" => "eed796c2-1067-4fd9-9a83-6fef519b33b9", "initial_count" => 0 , "image" => "img_cpns_ce_ubuntu_18.04_v1", "version" => "18.04_v1", "os" => "ubuntu" ,"name" => "ce"],
        ["uid" => "99408b15-58cd-4183-beb8-683080abb4f8", "initial_count" => 41 , "image" => "img_cpns_ciot_ubuntu_16.04_v5", "version" => "16.04_v5", "os" => "ubuntu" ,"name" => "ci"],
        ["uid" => "78ef70a5-f344-428a-920a-28e9b1a60a7e", "initial_count" => 0 , "image" => "img_cpns_dds_ubuntu_16.04_v4", "version" => "16.04_v4", "os" => "ubuntu" ,"name" => "dd"],
        ["uid" => "b10f22b2-1b0f-4af1-8856-9d5adab5be0f", "initial_count" => 0 , "image" => "img_cpns_dds_window_10_v0", "version" => "10", "os" => "window" ,"name" => "dd"],
        ["uid" => "6fb42e63-c472-4dc7-8936-9b512f7e27ef", "initial_count" => 0 , "image" => "img_cpns_dpp_window_10_v0", "version" => "10", "os" => "window" ,"name" => "dp"],
        ["uid" => "5cb16397-d5de-4b01-bb19-e2d5a13ad334", "initial_count" => 0 , "image" => "img_cpns_er_ubuntu_16.04", "version" => "16.04", "os" => "ubuntu" ,"name" => "er"],
        ["uid" => "e568d597-0230-4cc3-a86e-38e5149686b3", "initial_count" => 0 , "image" => "img_cpns_gig2.5_ubuntu_16.04_v1", "version" => "16.04_v1", "os" => "ubuntu" ,"name" => "gi"],
        ["uid" => "0c2ee07e-e3ee-43df-bbf9-a7d49e9b699a", "initial_count" => 0 , "image" => "img_cpns_gig2.5aaa_ubuntu_16.04", "version" => "16.04_v4", "os" => "ubuntu" ,"name" => "gi"],
        ...
        ["uid" => "9931d672-6e10-4c38-adb3-4bcef5ee339a", "initial_count" => 0 , "image" => "img_cpns_start_ubuntu_16.04_v0", "version" => "16.04", "os" => "ubuntu" ,"name" => "st"],
        ["uid" => "614233c5-4893-4c53-a0bd-27b030b0cf5a", "initial_count" => 0 , "image" => "img_cpns_vision_centos_7.5", "version" => "7.5", "os" => "centos" ,"name" => "vi"],
        ["uid" => "9fd2db39-9ae8-4630-9561-27d9b4307c7f", "initial_count" => 0 , "image" => "img_cpns_vision_window_10", "version" => "10", "os" => "window" ,"name" => "vi"],
        ["uid" => "efb32f16-852c-4568-ae38-3678701c5e44", "initial_count" => 0 , "image" => "img_cpns_vodafoneid_ubuntu_16.04_v1", "version" => "16.04_v1", "os" => "ubuntu" ,"name" => "vd"],
        ["uid" => "f3272575-72a9-491b-aa87-7a8d3c9a53e0", "initial_count" => 0 , "image" => "img_cpns_vodafoneid_ubuntu_18.04_v0", "version" => "18.04", "os" => "ubuntu" ,"name" => "vd"],
        ...
        ["uid" => "3ad18fa1-a7fa-4369-9434-b8b3e3704419", "initial_count" => 0 , "image" => "img_adcws_pace_window_10_v1", "version" => "10_v1", "os" => "window" ,"name" => "pc"],
