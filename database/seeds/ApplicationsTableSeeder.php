...
class ApplicationsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        ["uid" => "8923ab6d-c17b-488e-b22f-225242247b5d", "version" => "10_v2", "os" => "window" ,"name" => "poc"],
        ["uid" => "42ca21de-eee4-4e79-8cc0-e9f8958969b8", "version" => "6.9", "os" => "centos" ,"name" => "poc"],
        ["uid" => "10880706-1646-47d6-b1c9-41474b5c0194", "version" => "6.10", "os" => "rhel" ,"name" => "poc"],
        ["uid" => "2b0aba18-edc4-493c-b9b8-3f2072767bd8", "version" => "7.5", "os" => "rhel" ,"name" => "poc"],
        ["uid" => "ae4542eb-c113-4eb9-99ad-4f32684f5d74", "version" => "7.6", "os" => "rhel" ,"name" => "poc"],
        ["uid" => "07196bf9-36ef-41af-af04-d804c2ae3113", "version" => "7.7", "os" => "rhel" ,"name" => "poc"],
        ["uid" => "a66a62ae-d94e-40c4-8fba-0f2e2c1f58a5", "version" => "6.04", "os" => "ubuntu" ,"name" => "poc"],
        ["uid" => "847178af-0835-48d1-afa0-8dc9e498f7ef", "version" => "18.04_v1", "os" => "ubuntu" ,"name" => "poc"],
        ["uid" => "6407d9ac-9b89-4dc8-b930-197b1245cfca", "version" => "18.10_v1", "os" => "ubuntu" ,"name" => "poc"],
        ["uid" => "925bcbac-380d-477e-b604-73797f736baf", "version" => "16.04_v2", "os" => "ubuntu" ,"name" => "poc"],
        ["uid" => "e1a73112-f928-450a-9af7-d0f5cac1d04a", "version" => "18.04_v1", "os" => "ubuntu" ,"name" => "poc"],
        ...
        ["uid" => "993a27b3-8068-4935-9810-3288866e2ee1", "version" => "18.04_v1", "os" => "ubuntu" ,"name" => "gg"],
        ["uid" => "e3a474df-e8cb-4cdd-80f6-701f6d3edeb1", "version" => "18.04", "os" => "ubuntu" ,"name" => "hs"],
